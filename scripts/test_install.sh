...
# Build Diduny TEST and install to /Applications
# This script builds the test version with "Diduny TEST" name
...
BUNDLE_ID="ua.com.rmarinsky.diduny.test"
BUILD_DIR="$PROJECT_DIR/build/test-install"
